...
uint64 FNDServerTelemetry::ImpossibleRotationsTotal = 0;
...
void FNDServerTelemetry::RecordImpossibleRotation()
{
    ++ImpossibleRotationsTotal;
}
...
FNDServerTelemetrySnapshot FNDServerTelemetry::Snapshot()
{
    ...
    Result.ImpossibleRotationsTotal = ImpossibleRotationsTotal;
...
void FNDServerTelemetry::MaybeLog(double WorldSeconds)
{
    ...
    UE_LOG(
        ...
        static_cast<unsigned long long>(Current.ImpossibleRotationsTotal),
