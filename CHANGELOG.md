...
- PostgreSQL physical-standby promotion evidence uses an isolated CI-only replication trust rule and still reads authoritative state from PostgreSQL after promotion; automatic failover/fencing, interrupted-transaction safety, Redis failover, production RPO/RTO, regional DR, and live Unreal recovery remain unproven
