...
- authoritative race runtime v0.7 service-plane logic,
...
- server-only shared-key internal boundary,
...
- player clients blocked from directly submitting durable race results,
- race start binding to owned Roadworthy vehicle + exact active build revision/hash,
- ordered checkpoint cursor and monotonic elapsed-time enforcement,
- deterministic final result hashes,
...
- Rewardable/ranked state transitions require replay/idempotency protection.
